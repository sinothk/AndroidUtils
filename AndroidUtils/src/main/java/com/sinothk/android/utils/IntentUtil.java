...
public class IntentUtil {
    ...
    public IntentBuilder openActivity(Activity currActivity, Class<?> gotoActivity) {
    ...
    public class IntentBuilder {
        ...
        IntentBuilder(Activity currActivity, Class<?> paramClass) {
...
//                currActivity.overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
    ...
    public void openInnerActivity(Activity currActivity, String pkg, String activity) {
    ...
    public void openOtherApp(Activity currActivity, String pkg, String activity) {
    ...
    public String openOtherApp(Activity currActivity, String pkg, Bundle bundle) {
    ...
    public void downLoadByBrowser(Context mContext, String url) {
        Intent intent = new Intent();
