...
public class StringUtil {
     ...
     * @return
     */
    public String getNotNullValue(String value, String defaultValue) {
        if (TextUtils.isEmpty(value) || value.trim().length() == 0
                || "null".equals(value.trim()) || "Null".equals(value.trim())
                || "NULL".equals(value.trim()) || "None".equals(value.trim())) {
            value = defaultValue;
     ...
     * @return
     */
    public boolean isBetweenAtoB(String value, int a, int b) {
        if (isEmpty(value)) {
            return false;
        }
     ...
     * @return
     */
    public String getStarString(String paramString) {
        try {
    ...
    public String getStarStringByType(String paramString, int type) {
     ...
     * @return
     */
    public ArrayList<String> getArrayListByFlag(String head, String str, String flag) {
    ...
    private final Pattern emailer = Pattern
            .compile("\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*");
    private final Pattern IMG_URL = Pattern
     ...
     * @return
     */
    public Object string2Obj(String ret) {
        Object obj = null;
        if (ret != null) {
     ...
     * @return
     */
    public int getCharNum(String string, String ch) {
        int pos = -2;
        int n = 0;
     ...
     * @return
     */
    public String getMenyTypeXXXX00(float money) {
     ...
     * @return
     */
    public String getMenyTypeXXXX_DOT_00(float money) {
        DecimalFormat df1 = new DecimalFormat("####.00");
     ...
     * @return
     */
    public String getStarString(String str, int start, int end) {
        try {
    ...
    public boolean isSpace(String filePath) {
...
//                String speChat = "[`~!@#_$%^&*()+=|{}':;',\\[\\].<>/?~！@#￥%……&*（）— +|{}【】‘；：”“’。，、？]";
     ...
     * @return
     */
    public boolean checkPhoneNum(String userPhone) { //^1([358][0-9]|4[579]|66|7[0135678]|9[89])[0-9]{8}$
     ...
     * @return
     */
    public boolean isHanNumLetterPunctuationChar(String str) {
